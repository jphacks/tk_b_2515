...
import { Heart, Settings, Bell, Lock, CreditCard, HelpCircle, LogOut } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="p-4 bg-card/50 backdrop-blur-sm border-b border-border">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <Link href="/partner" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
      ...
      <main className="flex-1 p-4 sm:p-6">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-bold text-foreground">設定</h1>
          ...
          <Card className="p-6 border-2">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="font-medium text-foreground">セッションリマインダー</p>
                    <p className="text-sm text-muted-foreground">
                      予定の15分前に通知を受け取る
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="font-medium text-foreground">新規マッチング通知</p>
                    <p className="text-sm text-muted-foreground">
                      新しいセッション予約時に通知を受け取る
                    </p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={() => handleNotificationToggle("newMatchAlerts")}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
                  </label>
                ...
                <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-primary">0 ポイント</p>
                    </div>
