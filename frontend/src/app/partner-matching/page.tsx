...
import { ArrowLeft, Clock, Heart, Star, Users, Video } from "lucide-react";
...
export default function PartnerMatchingPage() {
	...
	const handleStartMatching = (partnerId: string, partnerName: string) => {
		// 支払いページへ遷移
		router.push(
			`/payment/checkout?partnerId=${partnerId}&partnerName=${encodeURIComponent(partnerName)}`,
		);
	};
	return (
